...
const components: JSXMapSerializer = {
  heading2: ({ children }) => (
    <Heading as="h2" size="md" className="text-center mb-9 font-display">
      {children}
    </Heading>
  ),
  paragraph: ({ children }) => (
    ...
    >
      ...
      <div className="grid lg:grid-cols-3 grid-cols-1 gap-8">
        {testimonials.map((item, index) => (
          <div
            className="border bg-white shadow-ld rounded-lg px-8 md:px-14 py-10 md:py-16 grid content-between"
            key={index}
          >
